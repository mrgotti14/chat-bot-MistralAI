...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#343541] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="flex flex-col space-y-4">
          <button
            ...
            className="w-full flex justify-center items-center gap-3 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#4285F4] hover:bg-[#357ABD] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4285F4]"
          >
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-3 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#24292e] hover:bg-[#1a1e21] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#24292e]"
          >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-[#343541] text-gray-400">Ou</span>
          </div>
        </div>
