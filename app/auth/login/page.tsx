      ...
      <div className="min-h-screen bg-[#1C1D1F] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            >
              Ou{' '}
              <Link href="/auth/register" className="font-medium text-[#A435F0] hover:text-[#8710E0] transition-colors">
                créez un compte
              </Link>
            </motion.p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#1C1D1F] text-gray-400">Connectez-vous avec</span>
            </div>
          </motion.div>
